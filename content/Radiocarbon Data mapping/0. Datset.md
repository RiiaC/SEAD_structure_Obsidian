...
- **[[master_notes]]** fill in a description or complimentary information relating to the specific research group, laboratory, or department that is useful for future users of this data to know about the source.
- **[[biblio_id]]** copy this information from the **system_id** numbers of the biblio sheet of this spreadsheet (see the note for column **O. Source**). (*This value will be 1, because the paper that generated the data for the dataset should be the first one listed in the list of references associated with the data.*)
...
- **[[master_set_id]]**
# contacts
>[!info] We also need to record the contact informaiton for the researcher who provided the dataset
...
system_id	contact_id	address_1	address_2	first_name	last_name	url	phone_number	email	location_id
